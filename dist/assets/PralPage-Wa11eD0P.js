import{S as ae,r as ie,M as se,_ as ne}from"./vue3-grid-layout-nHUTMh1D.js";import{d as re,r as h,i as oe,j as R,k as ce,c as D,a as n,w as c,u as s,g as x,n as S,l as E,m as pe,v as de,p as P,F as T,h as A,q as ue,s as I,f as w,t as M,T as me,x as v,I as q,S as $,y as Y,z as ge,B,D as fe,A as he,E as ke,G as ve}from"./index-DeEmSq7W.js";const m={fullNotLink:'<div style="position: relative"><img class="img_linkpage" src="{{src}}" alt="img" /></div>',fullHaveLink:'<div style="position: relative"><a href="{{link}}" id="ga_event_click" {{target_blank}}><span class="blind">{{spanBlind}}</span><img class="img_linkpage" src="{{src}}" alt="img" /></a></div>',absoluteLinks:'<div style="position: relative">{{list_link}}<img class="img_linkpage" src="{{src}}" alt="img" /></div>',onlyLink:'<a href="{{link}}" id="ga_event_click" style="background-color: transparent; {{position}}" {{target_blank}}><span class="blind">{{spanBlind}}</span></a>',grid:'<div style="display: grid; grid-template-columns: repeat({{col}}, 1fr); grid-gap: 0;">{{list_link}}</div>',root:`{{head}}
